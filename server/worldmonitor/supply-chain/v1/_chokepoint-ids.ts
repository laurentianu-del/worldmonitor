...
export const CANONICAL_CHOKEPOINTS: readonly CanonicalChokepoint[] = [
  ...
  { id: 'bosphorus', relayName: 'Bosphorus Strait', portwatchName: 'Bosporus Strait', corridorRiskName: null },
  { id: 'dardanelles', relayName: 'Dardanelles', portwatchName: '', corridorRiskName: null },
